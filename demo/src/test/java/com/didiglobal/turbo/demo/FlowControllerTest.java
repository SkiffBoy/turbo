...
public class FlowControllerTest {
    ...
    public void createFlow() {
        ...
        Assertions.assertTrue(res.getErrCode() == ErrorEnum.SUCCESS.getErrNo()); //1000 成功
    ...
    public void createFlowModel() {
        Assertions.assertTrue(flowModuleId != null);
    }
    ...
    public void saveFlowModel() {
        ...
        Assertions.assertEquals(ErrorEnum.SUCCESS.getErrNo(), res.getErrCode()); //1000 成功
    }
    ...
    public void queryFlow() {
        deployFlow();
        Assertions.assertTrue(flowModuleId != null && flowDeployId != null);
